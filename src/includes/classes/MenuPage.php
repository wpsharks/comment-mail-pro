...
class MenuPage extends AbsBase
{
    ...
    protected function options®()
    {
        ...
        $shortcode_details = function ($shortcodes) use ($_this) {
            ...
            if ($detail_lis) { // If we have shortcodes, let's list them.
                ...
                $details = __('No shortcodes for this template at the present time.', $_this->plugin->text_domain);
            }
        ...
        echo $this->panel(__('Enable/Disable', $this->plugin->text_domain), $_panel_body, ['open' => !$this->plugin->options['enable']]);
        ...
        echo $this->panel(__('Data Safeguards', $this->plugin->text_domain), $_panel_body, []);
        ...
        echo $this->panel(__('Email Message Headers', $this->plugin->text_domain), $_panel_body, []);
        ...
        echo $this->panel(__('Postmaster / Contact Info', $this->plugin->text_domain), $_panel_body, []);
        ...
        echo $this->panel(__('Powered by Notes', $this->plugin->text_domain), $_panel_body, ['note' => sprintf(__('Help support %1$s&trade;', $this->plugin->text_domain), esc_html($this->plugin->name))]);
        ...
        echo $this->panel(__('Comment Form', $this->plugin->text_domain), $_panel_body, []);
        ...
        $_panel_body .= '<div class="pmp-if-enabled-show"><hr />'.
                        ...
                        $form_fields->inputRow(
                          [
                            ...
                            'notes_after'   => '<p>'.sprintf(__('These are the %2$s that will trigger automatic subscriptions; i.e., %1$s will only auto-subscribe people to these types of posts. The default list is adequate for most sites. However, if you have other %2$s enabled by a theme/plugin, you might wish to include those here. e.g., <code>post,page,portfolio,gallery</code>; where <code>portfolio,gallery</code> might be two %3$s that you add to the default list, if applicable.', $this->plugin->text_domain), esc_html($this->plugin->name), $this->plugin->utils_markup->xAnchor('http://codex.wordpress.org/Post_Types', __('Post Types', $this->plugin->text_domain)), $this->plugin->utils_markup->xAnchor('http://codex.wordpress.org/Post_Types#Custom_Post_Types', __('Custom Post Types', $this->plugin->text_domain))).'</p>',
                          ]
                        ).
                        '    </tbody>'.
                        ' </table>'.
        ...
        echo $this->panel(__('Auto-Subscribe Settings', $this->plugin->text_domain), $_panel_body, []);
        ...
        echo $this->panel(__('Auto-Confirm Settings', $this->plugin->text_domain), $_panel_body, []);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Geo IP Region/Country Tracking', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Email Notification Clips', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('SMTP Server Integration', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Replies via Email (RVE Handler)', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            $_panel_body .= '<div class="pmp-if-enabled-show pmp-if-nest">'.
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Twitter oAuth Consumer Key: &nbsp;&nbsp; <small><em>[%1$s]</em></small>', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://comment-mail.com/kb-article/sso-integration/#-twitter', __('instructions', $this->plugin->text_domain))),
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Facebook oAuth App ID: &nbsp;&nbsp; <small><em>[%1$s]</em></small>', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://comment-mail.com/kb-article/sso-integration/#-facebook', __('instructions', $this->plugin->text_domain))),
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Google oAuth Client ID: &nbsp;&nbsp; <small><em>[%1$s]</em></small>', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://comment-mail.com/kb-article/sso-integration/#-google', __('instructions', $this->plugin->text_domain))),
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('LinkedIn oAuth API/Consumer Key: &nbsp;&nbsp; <small><em>[%1$s]</em></small>', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://comment-mail.com/kb-article/sso-integration/#-linkedin', __('instructions', $this->plugin->text_domain))),
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Blacklisted Email Addresses', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            $_panel_body .= '<table>'.
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Unconfirmed Expiration Time (<code>%1$s</code> Compatible)', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://php.net/manual/en/function.strtotime.php', 'strtotime')),
            ...
            $_panel_body .= '<table>'.
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Trash Expiration Time (<code>%1$s</code> Compatible)', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://php.net/manual/en/function.strtotime.php', 'strtotime')),
                                'placeholder'   => __('e.g., 60 days', $this->plugin->text_domain),
            ...
            echo $this->panel(__('Sub. Cleaner Adjustments', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            $_panel_body .= '<table>'.
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Sub. Event Log Expiration Time (<code>%1$s</code> Compatible)', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://php.net/manual/en/function.strtotime.php', 'strtotime')),
            ...
            $_panel_body .= '<table>'.
                            ...
                            $form_fields->inputRow(
                              [
                                'label'         => sprintf(__('Queue Event Log Expiration Time (<code>%1$s</code> Compatible)', $this->plugin->text_domain), $this->plugin->utils_markup->xAnchor('http://php.net/manual/en/function.strtotime.php', 'strtotime')),
                                'placeholder'   => __('e.g., 7 years', $this->plugin->text_domain),
            ...
            echo $this->panel(__('Log Cleaner Adjustments', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Queue Processor Adjustments', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        $_panel_body = '<table>'.
                       ...
                       $form_fields->inputRow(
                         [
                           ...
                           'notes_after'   => '<p>'.sprintf(__('If you can <code>%2$s</code>, you can always manage subscriptions and %1$s options, no matter what you configure here. However, if you have other users that help manage your site, you can set a specific %3$s they\'ll need in order for %1$s to allow them access. Users w/ this capability will be allowed to manage subscriptions, the mail queue, event logs, and statistics; i.e., everything <em>except</em> change %1$s options. To alter %1$s options you\'ll always need the <code>%2$s</code> capability.', $this->plugin->text_domain), esc_html($this->plugin->name), $this->plugin->utils_markup->xAnchor('http://codex.wordpress.org/Roles_and_Capabilities#'.$this->plugin->cap, $this->plugin->cap), $this->plugin->utils_markup->xAnchor('http://codex.wordpress.org/Roles_and_Capabilities', __('WordPress Capability', $this->plugin->text_domain))).'</p>',
                         ]
                       ).
                       '  </tbody>'.
                       '</table>';

        echo $this->panel(__('Subscription Management Access', $this->plugin->text_domain), $_panel_body, []);
        ...
        $_panel_body = '<table>'.
                       ...
                       $form_fields->inputRow(
                         [
                           ...
                           'notes_after'   => '<p>'.sprintf(__('These are %2$s NOT associated w/ comments in any way; i.e., %1$s will not display its meta boxes in the post editing station for these types of posts. The default list is adequate for most sites. However, if you have other %2$s enabled by a theme/plugin, you might wish to include those here. e.g., <code>portfolio,gallery</code> might be two %3$s that you add to the default list, assuming these are not to be associated w/ comments.', $this->plugin->text_domain), esc_html($this->plugin->name), $this->plugin->utils_markup->xAnchor('http://codex.wordpress.org/Post_Types', __('Post Types', $this->plugin->text_domain)), $this->plugin->utils_markup->xAnchor('http://codex.wordpress.org/Post_Types#Custom_Post_Types', __('Custom Post Types', $this->plugin->text_domain))).'</p>',
                         ]
                       ).
                       '  </tbody>'.
                       '</table>';

        echo $this->panel(__('Post Meta Box Settings', $this->plugin->text_domain), $_panel_body, []);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Template-Related Settings', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Misc. UI-Related Settings', $this->plugin->text_domain), $_panel_body, ['pro_only' => true]);
    ...
    protected function importExport®()
    {
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            $_panel_body .= ' <p class="pmp-note pmp-warning" style="font-size:90%;">'.sprintf(__('<strong>Upper Limits:</strong> There is an upper limit of <code>5000</code> lines allowed per import; i.e., you must limit each import to this number of lines so as to avoid extremely long-running PHP processes. In addition, given your current web host (i.e., PHP configuration); if you choose to upload a prepared CSV file, the maximum allowed file upload size is currently: <code>%1$s</code>.', $this->plugin->text_domain), esc_html($this->plugin->utils_fs->bytesAbbr($this->plugin->utils_env->maxUploadSize()))).'</p>';
            ...
            echo $this->panel(__('CSV Import and/or Mass Update', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-upload"></i>', 'pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('CSV Export (File Download)', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-download"></i>', 'pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Import Config. Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-upload"></i>', 'pro_only' => true]);
        ...
        if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
            ...
            echo $this->panel(__('Export Config. Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-download"></i>', 'pro_only' => true]);
    ...
    protected function emailTemplates®()
    {
        ...
        if ($this->plugin->options['template_type'] === 's') { // Simple snippet-based templates.
            ...
            echo $this->panel(__('Email Header Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes']);
            ...
            echo $this->panel(__('Email Footer Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes']);
            ...
            echo $this->panel(__('Subscr. Confirmation Subject', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Subscr. Confirmation Message Body', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Comment Notification Subject', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Comment Notification Message Heading', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Comment Notification Message In-Response-To', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Comment Notification Message Reply-From', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Comment Notification Message Comment-From', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Email Header', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Email Header Styles', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Email Header Scripts', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Email Header Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes', 'pro_only' => true]);
            ...
            echo $this->panel(__('Email Footer Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes', 'pro_only' => true]);
            ...
            echo $this->panel(__('Email Footer', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Subscr. Confirmation Subject', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Subscr. Confirmation Message Body', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Comment Notification Subject', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Comment Notification Message Body', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
    ...
    protected function siteTemplates®()
    {
        ...
        if ($this->plugin->options['template_type'] === 's') { // Simple snippet-based templates.
            ...
            echo $this->panel(__('Site Header Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes']);
            ...
            echo $this->panel(__('Site Footer Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes']);
            ...
            echo $this->panel(__('Subscr. Confirmed', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Unsubscribed', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Unsubscribed All', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            echo $this->panel(__('Comment Form Subscr. Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>']);
            ...
            if ($this->plugin->is_pro || $this->plugin->utils_env->isProPreview()) {
                ...
                echo $this->panel(__('Comment Form SSO Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
                ...
                echo $this->panel(__('Login Form SSO Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Site Header', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Site Header Styles', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Site Header Scripts', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Site Header Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes', 'pro_only' => true]);
            ...
            echo $this->panel(__('Site Footer Tag', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'note' => 'Recommended for Simple Branding Changes', 'pro_only' => true]);
            ...
            echo $this->panel(__('Site Footer', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Subscr. Confirmed', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Unsubscribed', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Unsubscribed All', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Summary', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Add/Edit Form', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Comment ID Row via AJAX', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Comment Form Subscr. Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Comment Form Scripts for Subscr. Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Comment Form Scripts for SSO Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Login Form Scripts for SSO Options', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
            ...
            echo $this->panel(__('Single Sign-on Registration Completion', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-code"></i>', 'pro_only' => true]);
    ...
    protected function proUpdater®()
    {
        ...
        echo $this->panel(__('Update Credentials', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-key"></i>', 'open' => true, 'pro_only' => true]);
        ...
        echo $this->panel(__('Update Notifier', $this->plugin->text_domain), $_panel_body, ['icon' => '<i class="fa fa-bullhorn"></i>', 'open' => true, 'pro_only' => true]);
    ...
    protected function heading($title, $logo_icon = '')
    {
        ...
        $heading .= '     <span> '.sprintf(__('%1$s&trade; Pro v%2$s (<a href="https://comment-mail.com/changelog/" target="_blank">changelog</a>)', $this->plugin->text_domain), esc_html($this->plugin->name), esc_html($this->plugin->version)).'</span>'."\n";
        $heading .= '  </div>'."\n";
