                            ...
                            $form_fields->inputRow(
                              [
                                ...
                                'notes_after'   => '<p>'.sprintf(
                                    ...
                                    '<p class="pmp-note pmp-info">'.__('If you empty this field, unconfirmed subscriptions will not be cleaned, they will remain indefinitely.', $this->plugin->text_domain), $this->plugin->utils_markup->x_anchor('http://php.net/manual/en/function.strtotime.php', 'strtotime')
                                  ).'</p>',
                              ]
                            ).
                            '  </tbody>'.
                            ...
                            $form_fields->inputRow(
                              [
                                ...
                                'notes_after'   => '<p>'.sprintf(
                                    ...
                                    '<p class="pmp-note pmp-info">'.__('If you empty this field, trashed subscriptions will not be cleaned, they will remain indefinitely.', $this->plugin->text_domain), $this->plugin->utils_markup->x_anchor('http://php.net/manual/en/function.strtotime.php', 'strtotime')
                                  ).'</p>',
                              ]
                            ).
                            '  </tbody>'.
