        ...
        <div class="col-md-6 text-left">
            ...
            <?php if ($parent_template->file() !== 'site/sub-actions/manage-summary.php') : ?>
                ...
                <a href="<?php echo esc_attr($sub_summary_return_url); ?>">
                    <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> <?php echo __('My Comment Subscriptions', SLUG_TD); ?>
                </a>
                <span class="text-muted">|</span>
            <?php endif; ?>

            <a href="<?php echo esc_attr($home_url); ?>">
                <i class="fa fa-home" aria-hidden="true"></i> <?php echo sprintf(__('Return to <em>%1$s</em>', SLUG_TD), esc_html($blog_name_clip)); ?>
            </a>
