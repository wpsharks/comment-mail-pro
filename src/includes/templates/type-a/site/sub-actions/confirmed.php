    ...
    <div class="confirm">
        ...
        <?php else : // Confirmed successfully. ?>
            ...
            <div class="alert alert-success">
                <h4 style="margin:0;">
                    <i class="fa fa-check fa-fw" aria-hidden="true"></i> <?php echo sprintf(__('Confirmed successfully. Thank you%1$s!', SLUG_TD), $sub->fname ? ' '.esc_html($sub->fname) : ''); ?>
                </h4>
            </div>
            ...
            <h5 style="font-style:italic; margin:0;">
                <i class="fa fa-lightbulb-o" aria-hidden="true"></i> <?php echo sprintf(__('If any of this is incorrect, please <a href="%1$s">click here to edit</a> your subscription.', SLUG_TD), esc_attr($sub_edit_url)); ?>
            </h5>
