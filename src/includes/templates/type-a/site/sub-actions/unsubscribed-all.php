    ...
    <div class="unsubscribe-all">
        ...
        <?php else : // Unsubscribed all successfully. ?>
            ...
            <div class="alert alert-success" style="margin:0;">
                <h4 style="margin:0;">
                    <i class="fa fa-check fa-fw" aria-hidden="true"></i> <?php echo __('Unsubscribed all successfully. Sorry to see you go!', SLUG_TD); ?>
                </h4>
            </div>

            <h4>
                <?php echo sprintf(__('&lt;%1$s&gt; will no longer be notified about any comments/replies.', SLUG_TD), esc_html($sub_email)); ?>
            </h4>
