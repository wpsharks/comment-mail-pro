...
<?php if($sub_comment): // Subscribed to a specific comment? ?>
	...
	<?php if($subscribed_to_own_comment): ?>
		<?php echo sprintf(__('to your comment on <em>%1$s</em>', $plugin->text_domain), $sub_post_title_clip); ?>
	<?php else: // The comment was not authored by this subscriber; i.e. it's not their own. ?>
		<?php echo sprintf(__('to comment ID #%1$s on <em>%2$s</em>', $plugin->text_domain), $sub_comment->comment_ID, $sub_post_title_clip); ?>
	<?php endif; ?>

<?php else: // All comments/replies to this post. ?>
	<?php echo sprintf(__('to <em>%1$s</em>', $plugin->text_domain), $sub_post_title_clip); ?>
<?php endif; ?>
