				...
				$_panel_body .= '<div class="pmp-if-enabled-show">'.
					                ...
					                : $form_fields->textarea_row( // Simple snippet-based template.
						                array(
							                ...
							                'cm_details'    => $shortcode_details(array(
								                                                      ...
								                                                      '[sub_deliver_options]' => __('Select menu options. Allows a subscriber to choose a delivery option; e.g., instantly, hourly, daily, weeky. This can be excluded if you wish. A default value of <code>instantly</code> will be used in that case.', $this->plugin->text_domain),
				                ...
				                $form_fields->select_row(
					                array(
						                ...
						                'notes_after'     => $this->plugin->options['template_type'] === 'a'
							                ? '<p>'.__('This is the option that will be pre-selected for each commenter as the default value. You can change the wording that appears for these options by editing the template above. However, the default choice is determined systematically, based on the one that you choose here — assuming that you haven\'t dramatically altered code in the template. For most sites, the most logical default choice is: <code>instantly</code>; i.e., the commenter will receive instant notifications regarding replies to their comment.', $this->plugin->text_domain).'</p>'
							                : '<p>'.__('This is the option that will be pre-selected for each commenter as the default value. For most sites, the most logical default choice is: <code>instantly</code>; i.e., the commenter will receive instant notifications regarding replies to their comment.', $this->plugin->text_domain).'</p>',
					                )).
				                '     </tbody>'.
				                '  </table>'.
				                '</div>';
				...
				$_panel_body .= '<div class="pmp-if-enabled-show"><hr />'.
				                ...
				                $form_fields->select_row(
					                array(
						                ...
						                'allow_arbitrary' => FALSE, // Must be one of these.
						                'options'         => '%%deliver%%', // Predefined options.
						                'notes_after'     => '<p>'.__('Whenever someone is auto-subscribed, this is the delivery option that will be used. Any value that is not <code>instantly</code> results in a digest instead of instant notifications.', $this->plugin->text_domain).'</p>',
					                )).
				                '    </tbody>'.
				                ' </table>'.
					               ...
					               $form_fields->textarea_row(
						               array(
							               ...
							               'cm_details'    => $shortcode_details(array(
								                                                     ...
								                                                     '[sub_deliver_label]'            => __('Delivery option label; e.g., instantly, hourly, daily, weekly.', $this->plugin->text_domain),
